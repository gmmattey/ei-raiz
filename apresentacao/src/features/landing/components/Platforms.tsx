...
const PLATFORM_CARDS = [
  ...
  { name: 'iOS', status: APP_STORE_URL ? 'Disponível' : 'Planejado' },
]
  ...
  return (
    <section id="plataformas" className="px-5 py-20 sm:px-8 sm:py-28" style={{ background: 'var(--bg-secondary)' }}>
      <div className="mx-auto max-w-3xl text-center">
        <h2 className="mb-4 text-[1.75rem] font-bold sm:text-[2.25rem]">Onde o Savro vai estar</h2>
        <p className="mx-auto mb-12 max-w-xl text-[1.0625rem] leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          O app ainda não foi publicado em nenhuma loja. Assim que estiver disponível, o link aparece aqui.
        </p>
        ...
        <p className="mt-8 text-[13px]" style={{ color: 'var(--text-tertiary)' }}>
          {SUPPORT_EMAIL ? (
            ...
            'Canal para avisar sobre o lançamento ainda não configurado.'
          )}
        </p>
      </div>
    </section>
