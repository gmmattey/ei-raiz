...
const SpendOrInvestSimulator = () => {
  ...
  const [form, setForm] = useState({ nome: 'Gastar ou Investir', valor: 5000, prazoAnos: 10, retornoEsperado: 0.12, scoreAtual: 68 });
  ...
  return (
    <DecisionSimulatorLayout title="Gastar agora ou Investir" subtitle="Visualize o custo de oportunidade de um consumo imediato no seu longo prazo.">
      <div className="space-y-8">
        <DecisionFormSection title="Premissas da decisão" description="Parâmetros do cenário" icon={ShoppingBag}>
          ...
          <MaskedInput label="Retorno esperado" type="number" value={form.retornoEsperado} onChange={onChange('retornoEsperado')} suffix="aa" step="0.01" />
